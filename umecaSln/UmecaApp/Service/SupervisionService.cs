	...
	public class SupervisionService  : Java.Lang.Object
	{
		...
		public Java.Lang.String Example(Java.Lang.String modelJson){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine("catched exception in SupervisionService method Example invoked javascript calling -> SupervisionService.upsertPersonalData() Exception message :::>"+e.Message);
		...
		public Java.Lang.String upsertDomicilioComment(Java.Lang.String modelJson){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine("catched exception in SupervisionService method upsertDomicilioComment invoked javascript calling -> SupervisionService.upsertDomicilioComment() Exception message :::>"+e.Message);
				output = new Java.Lang.String (Constants.MSG_ERROR_UPSERT);
			}
			finally{
				db.Commit ();
		...
		public Java.Lang.String upsertImputedHome(Java.Lang.String modelJson){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine ("catched exception in SupervisionService method upsertImputedHome invoked javascript calling -> SupervisionService.upsertImputedHome()");
		...
		public Java.Lang.String eraseImputedHome(Java.Lang.String idHome){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine ("catched exception in SupervisionService method eraseImputedHome invoked javascript calling -> SupervisionService.eraseImputedHome("+idHome+")");
				Console.WriteLine("Exception message :::>"+e.Message);
				output = new Java.Lang.String (Constants.MSG_ERROR_UPSERT);
			}
			finally{
		...
		public Java.Lang.String upsertPersonaRedSocial(Java.Lang.String modelJson){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine ("catched exception in SupervisionService method upsertPersonaRedSocial invoked javascript calling -> SupervisionService.upsertPersonaRedSocial()");
				Console.WriteLine("Exception message :::>"+e.Message);
				output = new Java.Lang.String (Constants.MSG_ERROR_UPSERT);
			}
			finally{
		...
		public Java.Lang.String erasePersonaRedSocial(Java.Lang.String PersonId){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine ("catched exception in SupervisionService method erasePersonaRedSocial invoked javascript calling -> SupervisionService.erasePersonaRedSocial()");
				Console.WriteLine("Exception message :::>"+e.Message);
		...
		public Java.Lang.String upsertRedSocialComment(Java.Lang.String modelJson){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine("catched exception in SupervisionService method upsertRedSocialComment invoked javascript calling -> SupervisionService.upsertRedSocialComment() Exception message :::>"+e.Message);
				output = new Java.Lang.String (Constants.MSG_ERROR_UPSERT);
			}
			finally{
				db.Commit ();
		...
		public Java.Lang.String upsertRefrerencia(Java.Lang.String modelJson){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine ("catched exception in SupervisionService method upsertReference invoked javascript calling -> SupervisionService.upsertReference()");
				Console.WriteLine("Exception message :::>"+e.Message);
				output = new Java.Lang.String (Constants.MSG_ERROR_UPSERT);
			}
			finally{
		...
		public Java.Lang.String eraseReferencia(Java.Lang.String ReferenceId){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine ("catched exception in SupervisionService method eraseReferencia invoked javascript calling -> SupervisionService.eraseReferencia()");
				Console.WriteLine("Exception message :::>"+e.Message);
				output = new Java.Lang.String (Constants.MSG_ERROR_DELETE);
			}
			finally{
		...
		public Java.Lang.String upsertReferenciasComment(Java.Lang.String modelJson){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine("catched exception in SupervisionService method upsertReferenciasComment invoked javascript calling -> SupervisionService.upsertReferenciasComment() Exception message :::>"+e.Message);
				output = new Java.Lang.String (Constants.MSG_ERROR_UPSERT);
			}
			finally{
				db.Commit ();
		...
		public Java.Lang.String upsertLaboral(Java.Lang.String modelJson){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine ("catched exception in SupervisionService method upsertLaboral invoked javascript calling -> SupervisionService.upsertLaboral()");
				Console.WriteLine("Exception message :::>"+e.Message);
				output = new Java.Lang.String (Constants.MSG_ERROR_UPSERT);
			}
			finally{
		...
		public Java.Lang.String eraseLaboral(Java.Lang.String idLaboral){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine ("catched exception in SupervisionService method eraseLaboral invoked javascript calling -> SupervisionService.eraseLaboral()");
				Console.WriteLine("Exception message :::>"+e.Message);
				output = new Java.Lang.String (Constants.MSG_ERROR_UPSERT);
			}
			finally{
		...
		public Java.Lang.String upsertDrug(Java.Lang.String modelJson){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine ("catched exception in SupervisionService method upsertDrug invoked javascript calling -> SupervisionService.upsertDrug()");
				Console.WriteLine("Exception message :::>"+e.Message);
				output = new Java.Lang.String (Constants.MSG_ERROR_UPSERT);
			}
			finally{
		...
		public Java.Lang.String eraseDrug(Java.Lang.String DrugId){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine ("catched exception in SupervisionService method eraseDrug invoked javascript calling -> SupervisionService.eraseDrug()");
				Console.WriteLine("Exception message :::>"+e.Message);
				output = new Java.Lang.String (Constants.MSG_ERROR_DELETE);
			}
			finally{
		...
		public Java.Lang.String upsertSchoolarship(Java.Lang.String modelJson){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine ("catched exception in SupervisionService method upsertSchoolarship invoked javascript calling -> SupervisionService.upsertSchoolarship()");
				Console.WriteLine("Exception message :::>"+e.Message);
				output = new Java.Lang.String (Constants.MSG_ERROR_UPSERT);
			}
			finally{
		...
		public Java.Lang.String upsertLeaveCountry(Java.Lang.String modelJson){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine ("catched exception in SupervisionService method upsertLeaveCountry invoked javascript calling -> SupervisionService.upsertLeaveCountry()");
				Console.WriteLine("Exception message :::>"+e.Message);
				output = new Java.Lang.String (Constants.MSG_ERROR_UPSERT);
			}
			finally{
...
/* end validaciones */
				...
				db.Rollback ();
				Console.WriteLine ("catched exception in SupervisionService method TerminateMeeting invoked javascript calling -> SupervisionService.TerminateMeeting()");
				Console.WriteLine("Exception message :::>"+e.Message);
				output = new Java.Lang.String (Constants.MSG_ERROR_UPSERT);
			}
			finally{
		...
		public Java.Lang.String allAcademicLevels(){
			...
			try{
				...
				Console.WriteLine("catched exception in SupervisionService method allAcademicLevels -> SupervisionService.allAcademicLevels() Exception message :::>"+e.Message);
				output = new Java.Lang.String ("[]");
			}
			return output;
		}
		...
		public Java.Lang.String gradeByNivel(Java.Lang.String Nivel){
			...
			try{
				...
				Console.WriteLine("catched exception in SupervisionService method gradeByNivel -> SupervisionService.gradeByNivel() Exception message :::>"+e.Message);
				output = new Java.Lang.String ("[]");
			}
			return output;
		}
		...
		public Java.Lang.String gradesBySelectedDegree(Java.Lang.String Degree){
			...
			try{
				...
				Console.WriteLine("catched exception in SupervisionService method gradesBySelectedDegree -> SupervisionService.gradesBySelectedDegree () Exception message :::>"+e.Message);
				output = new Java.Lang.String ("[]");
			}
			return output;
		}
		...
		public Java.Lang.String documentosMigratorios(){
			...
			try{
				...
				Console.WriteLine("catched exception in SupervisionService method documentosMigratorios -> SupervisionService.documentosMigratorios() Exception message :::>"+e.Message);
				output = new Java.Lang.String ("[]");
			}
			return output;
		}
