	...
	public class VerificationService  : Java.Lang.Object
	{
		...
		public Java.Lang.String Example(Java.Lang.String modelJson){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine("catched exception in VerificationService method Example invoked javascript calling -> VerificationService.upsertPersonalData() Exception message :::>"+e.Message);
		...
		public Java.Lang.String upsertDomicilioComment(Java.Lang.String modelJson){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine("catched exception in VerificationService method upsertDomicilioComment invoked javascript calling -> VerificationService.upsertDomicilioComment() Exception message :::>"+e.Message);
				output = new Java.Lang.String (Constants.MSG_ERROR_UPSERT);
			}
			finally{
				db.Commit ();
		...
		public Java.Lang.String upsertImputedHome(Java.Lang.String modelJson){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine ("catched exception in VerificationService method upsertImputedHome invoked javascript calling -> VerificationService.upsertImputedHome()");
		...
		public Java.Lang.String eraseImputedHome(Java.Lang.String idHome){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine ("catched exception in VerificationService method eraseImputedHome invoked javascript calling -> VerificationService.eraseImputedHome("+idHome+")");
				Console.WriteLine("Exception message :::>"+e.Message);
				output = new Java.Lang.String (Constants.MSG_ERROR_UPSERT);
			}
			finally{
		...
		public Java.Lang.String upsertPersonaRedSocial(Java.Lang.String modelJson){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine ("catched exception in VerificationService method upsertPersonaRedSocial invoked javascript calling -> VerificationService.upsertPersonaRedSocial()");
				Console.WriteLine("Exception message :::>"+e.Message);
				output = new Java.Lang.String (Constants.MSG_ERROR_UPSERT);
			}
			finally{
		...
		public Java.Lang.String erasePersonaRedSocial(Java.Lang.String PersonId){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine ("catched exception in VerificationService method erasePersonaRedSocial invoked javascript calling -> VerificationService.erasePersonaRedSocial()");
				Console.WriteLine("Exception message :::>"+e.Message);
		...
		public Java.Lang.String upsertRedSocialComment(Java.Lang.String modelJson){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine("catched exception in VerificationService method upsertRedSocialComment invoked javascript calling -> VerificationService.upsertRedSocialComment() Exception message :::>"+e.Message);
				output = new Java.Lang.String (Constants.MSG_ERROR_UPSERT);
			}
			finally{
				db.Commit ();
		...
		public Java.Lang.String upsertRefrerencia(Java.Lang.String modelJson){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine ("catched exception in VerificationService method upsertReference invoked javascript calling -> VerificationService.upsertReference()");
				Console.WriteLine("Exception message :::>"+e.Message);
				output = new Java.Lang.String (Constants.MSG_ERROR_UPSERT);
			}
			finally{
		...
		public Java.Lang.String eraseReferencia(Java.Lang.String ReferenceId){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine ("catched exception in VerificationService method eraseReferencia invoked javascript calling -> VerificationService.eraseReferencia()");
				Console.WriteLine("Exception message :::>"+e.Message);
				output = new Java.Lang.String (Constants.MSG_ERROR_DELETE);
			}
			finally{
		...
		public Java.Lang.String upsertReferenciasComment(Java.Lang.String modelJson){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine("catched exception in VerificationService method upsertReferenciasComment invoked javascript calling -> VerificationService.upsertReferenciasComment() Exception message :::>"+e.Message);
				output = new Java.Lang.String (Constants.MSG_ERROR_UPSERT);
			}
			finally{
				db.Commit ();
		...
		public Java.Lang.String upsertLaboral(Java.Lang.String modelJson){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine ("catched exception in VerificationService method upsertLaboral invoked javascript calling -> VerificationService.upsertLaboral()");
				Console.WriteLine("Exception message :::>"+e.Message);
				output = new Java.Lang.String (Constants.MSG_ERROR_UPSERT);
			}
			finally{
		...
		public Java.Lang.String eraseLaboral(Java.Lang.String idLaboral){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine ("catched exception in VerificationService method eraseLaboral invoked javascript calling -> VerificationService.eraseLaboral()");
				Console.WriteLine("Exception message :::>"+e.Message);
				output = new Java.Lang.String (Constants.MSG_ERROR_UPSERT);
			}
			finally{
		...
		public Java.Lang.String upsertDrug(Java.Lang.String modelJson){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine ("catched exception in VerificationService method upsertDrug invoked javascript calling -> VerificationService.upsertDrug()");
				Console.WriteLine("Exception message :::>"+e.Message);
				output = new Java.Lang.String (Constants.MSG_ERROR_UPSERT);
			}
			finally{
		...
		public Java.Lang.String eraseDrug(Java.Lang.String DrugId){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine ("catched exception in VerificationService method eraseDrug invoked javascript calling -> VerificationService.eraseDrug()");
				Console.WriteLine("Exception message :::>"+e.Message);
				output = new Java.Lang.String (Constants.MSG_ERROR_DELETE);
			}
			finally{
		...
		public Java.Lang.String upsertSchoolarship(Java.Lang.String modelJson){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine ("catched exception in VerificationService method upsertSchoolarship invoked javascript calling -> VerificationService.upsertSchoolarship()");
				Console.WriteLine("Exception message :::>"+e.Message);
				output = new Java.Lang.String (Constants.MSG_ERROR_UPSERT);
			}
			finally{
		...
		public Java.Lang.String upsertLeaveCountry(Java.Lang.String modelJson){
			...
			try{
				...
				db.Rollback ();
				Console.WriteLine ("catched exception in VerificationService method upsertLeaveCountry invoked javascript calling -> VerificationService.upsertLeaveCountry()");
				Console.WriteLine("Exception message :::>"+e.Message);
				output = new Java.Lang.String (Constants.MSG_ERROR_UPSERT);
			}
			finally{
...
/* end validaciones */
				...
				db.Rollback ();
				Console.WriteLine ("catched exception in VerificationService method TerminateMeeting invoked javascript calling -> VerificationService.TerminateMeeting()");
				Console.WriteLine("Exception message :::>"+e.Message);
				output = new Java.Lang.String (Constants.MSG_ERROR_UPSERT);
			}
			finally{
		...
		public Java.Lang.String allAcademicLevels(){
			...
			try{
				...
				Console.WriteLine("catched exception in VerificationService method allAcademicLevels -> VerificationService.allAcademicLevels() Exception message :::>"+e.Message);
				output = new Java.Lang.String ("[]");
			}
			return output;
		}
		...
		public Java.Lang.String gradeByNivel(Java.Lang.String Nivel){
			...
			try{
				...
				Console.WriteLine("catched exception in VerificationService method gradeByNivel -> VerificationService.gradeByNivel() Exception message :::>"+e.Message);
				output = new Java.Lang.String ("[]");
			}
			return output;
		}
		...
		public Java.Lang.String gradesBySelectedDegree(Java.Lang.String Degree){
			...
			try{
				...
				Console.WriteLine("catched exception in VerificationService method gradesBySelectedDegree -> VerificationService.gradesBySelectedDegree () Exception message :::>"+e.Message);
				output = new Java.Lang.String ("[]");
			}
			return output;
		}
		...
		public Java.Lang.String documentosMigratorios(){
			...
			try{
				...
				Console.WriteLine("catched exception in VerificationService method documentosMigratorios -> VerificationService.documentosMigratorios() Exception message :::>"+e.Message);
				output = new Java.Lang.String ("[]");
			}
			return output;
		}
